...
export default function HeroSection({ selectedLanguage }: HeroSectionProps) {
    ...
    return (
        <section className="flex flex-col items-center justify-center w-full h-[100vh] text-[#0E100F] dark:text-white space-y-6 font-halcyon bg-red-30">
            {/* Picture and name */}
            <div className="flex items-center space-x-3 md:space-x-5 rounded-md">
                ...
                <div className="border border-[#FFD074] rounded-full px-3 py-1 md:px-4 md:py-2 transition-transform transform hover:scale-105 hover:rotate-3">
                    <h1 className="text-lg md:text-xl text-[#0E100F] dark:text-[#FFFFE3] text-center">{greeting}</h1>
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center md:space-x-5 text-center md:text-left rounded-md">
                ...
                <p className="text-base md:text-lg font-bold font-Interphases mt-2 md:mt-0 hidden md:block">
                    {based}
                    <br />
                    <span className="text-[#C47B00] dark:text-[#FFD074]">{location}</span>
                </p>
            </div>

            {/* Developer and Connect Button */}
            <div className="flex flex-col md:flex-row items-center md:space-x-5 text-center md:text-left rounded-md">
                <h3 className="text-6xl md:text-8xl text-[#C47B00] dark:text-[#FFD074] font-bold font-Interphases">{developer}</h3>
                <a href="https://api.whatsapp.com/send?phone=5214498043308" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center bg-[#0E100F] dark:bg-white text-white dark:text-[#0E100F] px-5 py-2 md:px-6 md:py-3 rounded-md mt-2 md:mt-0">
            ...
            {/* AI Student */}
            <div className="flex flex-col md:flex-row items-center md:space-x-5 text-center md:text-left rounded-md">
                <h4 className="text-4xl md:text-6xl text-[#0A8A7E] dark:text-[#17F1D1] font-bold font-Interphases">{student}</h4>
                <p className="text-base md:text-lg font-bold font-Interphases mt-2 md:mt-0">
                    at
                    <br />
                    <span className="text-[#C47B00] dark:text-[#FFD074]">{university}</span>
                </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-5">
                <div className="flex flex-row space-x-5">
                    ...
                    <div className="flex space-x-3">
                        ...
                        <a href="mailto:diegocano98751@hotmail.com" className="group">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#0E100F] dark:bg-white text-white dark:text-black transition-all duration-300 ease-in-out transform group-hover:scale-110 group-hover:mx-1">
                ...
                >
                    <ChevronDown className="w-10 h-10 text-[#C47B00] dark:text-[#FFD074]" />
                    <span className="text-[#C47B00] dark:text-[#FFD074] text-sm mt-2">{scroll}</span>
                </div>
            </div>
        </section>
    )
